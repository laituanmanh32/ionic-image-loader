...
var ImageLoader = /** @class */ (function () {
     ...
     * @param {string} imageUrl Image URL
     */
    ImageLoader.prototype.clearImageCache = function (imageUrl) {
        var _this = this;
     ...
     * @returns {boolean}
     */
    ImageLoader.prototype.currentlyInQueue = function (imageUrl) {
     ...
     * @returns {string}
     */
    ImageLoader.prototype.getExtensionFromUrl = function (url) {
    ...
    ImageLoader = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [ImageLoaderConfig,
            File,
            HttpClient,
            Platform])
    ], ImageLoader);
